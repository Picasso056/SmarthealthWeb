...
<div class="head3" style="width:100%; height: 418px;">            
       ...
       <div style="float:left; width:48%; height: 340px;">
        ...
        UserName</label><br><br>
                                                          ...
                                                          <div style="float:right; width:50%; height: 343px;" class="auto-style2">
                                           
                <h1  style="color: #000000;" class="auto-style1"><b>HealthData</b></h1>
                <%  ArrayList<String> healthname = (ArrayList<String>)session.getAttribute("healthname");%>
                <%  ArrayList<String> healthvalue = (ArrayList<String>)session.getAttribute("healthvalue");%>
                                                                <label class="control-label col-sm-2" for="username" style="width: 24.666667%;">
        UserName</label><br><br>
