...
<div class="head3">			
		...
		<div class="g1">	
				...
				<h1  style="color: #000000;" class="auto-style1"><b>All Users</b></h1>
										 <form action="addfriend" method="post">					
																<%  ArrayList<String> friends = (ArrayList<String>)request.getAttribute("alluser");%>
																<label class="control-label col-sm-2" for="username" style="width: 26%;">UserName</label><br><br>
																<%for(String user : friends){ %>
																		
																	<div class="form-group">
																		 <label class="control-label col-sm-2" for="username" style="width: 26%;"><%= user %> </label>
																			  <input name="addfriend[<%= user %>]" type="submit" value="addfriend"><br>
