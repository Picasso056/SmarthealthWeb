 ...
 * Generated at: 2016-11-12 13:57:22 UTC
...
public final class AllForums_jsp extends org.apache.jasper.runtime.HttpJspBase
...
for(Forum i : forum){ 
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t\t<a href=\"GetAllPost?id=");
      out.print(i.getForumId());
      out.write('"');
      out.write('>');
